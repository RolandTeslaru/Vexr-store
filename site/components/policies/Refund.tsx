...
const Refund = () => {
  return (
    <>
        ...
        <br />
        <p>To start a return, you can contact us at cleverproductsstore@gmail.com.</p>
        <br />
        ...
        <br />
        <p>You can always contact us for any return question at cleverproductsstore@gmail.com. </p>
        <br />
...
If more than 15 business days have passed since we've approved your return, please contact us at cleverproductsstore@gmail.com.</p>
   </>
  )
}
