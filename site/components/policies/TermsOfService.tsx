  ...
  return (
    <>
      <>
        ...
        <br /> This website is operated by Vexr Group. Throughout the site, the
        terms “we”, “us” and “our” refer to Vexr. Vexr offers this website,
        ...
        conditions, policies and notices stated here. <br /> <br /> By visiting
        ...
        or contributors of content. <br /> <br /> Please read these Terms of
        ...
        non-infringement. <br /> In no case shall Vexr, our directors, officers,
        ...
        indemnify, defend and hold harmless Vexr and our parent, subsidiaries,
        ...
        the Terms of Service should be sent to us at support@vexr-store.com .
        <br /> Our contact information is posted below: <br />
        Vexr Group
        <br />
        <a
          href="mailto:support@vexr-store.com"
          data-mce-fragment="1"
          data-mce-href="mailto:support@vexr-store.com"
        >
          support@vexr-store.com
        </a>
        <br />
        <br />
      </>
